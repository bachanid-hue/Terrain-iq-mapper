...
const SYN_GROUPS: string[][] = [
  ...
  // Identifiers beyond CUSIP/ISIN
  ['sedol', 'sedolcode'],
  ['figi', 'figicode', 'bbgid', 'bloombergid'],
  ['lei', 'legalentityidentifier'],
  ['ric', 'reutersid'],
  // Dates and timing
  ['trade', 'trd'],
  ['tradedate', 'trddate', 'transactiondate', 'txndate'],
  ['settle', 'settlement', 'sttl'],
  ['settledate', 'settlementdate', 'sttldate'],
  ['valuedate', 'valdate'],
  ['effective', 'effectivedate', 'effdate'],
  ['asof', 'as_of', 'asofdate', 'reportdate', 'reportingdate'],
  // Trading / venues / parties
  ['broker', 'brkr'],
  ['custodian', 'custody', 'cust'],
  ['counterparty', 'cparty', 'counterpty'],
  ['exchange', 'exch', 'venue'],
  ['country', 'ctry', 'cntry'],
  ['region', 'geography', 'geo'],
  ['sector', 'gicssector'],
  ['industry', 'gicsindustry'],
  // Risk / performance metrics
  ['rating', 'creditrating', 'ratingagency'],
  ['spread', 'sprd'],
  ['convexity', 'cnvx'],
  ['frequency', 'freq'],
  ['notional', 'notionalamount', 'notionalvalue'],
  ['principal', 'prin'],
  ['gain', 'realizedgain', 'gainloss', 'pnl', 'profitloss'],
  ['unrealized', 'unrlzd', 'unreal'],
  ['realized', 'rlzd', 'real'],
  ['basis', 'costbasisamount'],
  ['strike', 'strikeprice'],
  ['expdate', 'expirationdate', 'expirydate'],
  ['delta', 'optiondelta'],
  ['multiplier', 'contractmultiplier', 'multi'],
  ['custody_account', 'custodyacct', 'custaccount'],
  ['fx', 'foreignexchange', 'forex'],
  ['rate', 'interestrate', 'intrate'],
];
